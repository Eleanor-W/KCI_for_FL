...
if __name__ == '__main__':
    ...
    if args.alg == 'fedavg':
        ...
        for round in range(args.comm_round):
            ...
            for i in range(len(total_data_points_arr)) :
                if total_data_points_arr[i] == max_value :
                    max_idx.append(i)
                if total_data_points_arr[i] > max_value :
                    max_idx = [i]
                    max_value = total_data_points_arr[i]
            chosen_idx = random.choice(max_idx)
